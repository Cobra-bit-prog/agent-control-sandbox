    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted">
          Off-policy sends pause here. The agent must not sign until you decide, or the request expires (10 minutes).
        </p>
      </div>
      ...
      {items.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center gap-3 p-10 text-center">
            ...
            <p className="text-sm text-muted">
              Inbox clear. Unknown destinations and over-cap sends will wait here.
            </p>
          </CardContent>
        </Card>
      )}
            ...
            <CardContent className="flex flex-col gap-4 p-5">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-2 font-mono text-xs text-muted">{shortAddress(it.to_address, 6)}</p>
